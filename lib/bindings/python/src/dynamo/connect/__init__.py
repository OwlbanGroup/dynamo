...
try:
    ...
    raise ImportError("NIXL Python bindings must be installed to use this module. Please install NIXL, ex: 'pip install nixl'.") from e

try:
    import torch
except ImportError as e:
    raise ImportError("PyTorch must be installed to use this module. Please install PyTorch, ex: 'pip install torch'.") from e
